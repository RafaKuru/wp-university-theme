    ...
    <div class="container">
        ...
        <div class="site-header__menu group">
            <nav class="main-navigation">
                <ul>
                    <li <?php echo (is_page('about-us') or wp_get_post_parent_id(0) == 11) ? 'class="current-menu-item"' : ''?>><a href="<?php echo site_url('/about-us')?>">About Us</a></li>
                    ...
                    <li <?php echo (get_post_type() == 'event' or is_page('past-events')) ? 'class="current-menu-item"' : ''?>><a href="<?php echo get_post_type_archive_link('event')?>">Events</a></li>
